...
# "@app.route"같은 에너테이션으로 URL을 매핑해주는 함수를 라우팅 함수라 함.
@bp.route('/hello') # __init__에선 app.route였지만 뷰파일에선 bp.route로 바뀌었다. 여기서 bp는 앞에서 생성한 블루프린트 객체다.
def hello_pybo():
    return 'Hello, Pybo!'
